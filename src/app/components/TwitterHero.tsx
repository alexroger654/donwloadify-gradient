...
// ========================================== components =====================================================
export default function TwitterHero({activeTab, setActiveTab, tabs, content}: {activeTab: string, setActiveTab: (tab: string) => void, tabs: { id: string; label: string; icon: any; }[], content: { title: string; description: string; placeholder: string; } }) {
    ...
    return (
        <section id="home" className="bg-gradient-to-r  from-[#1DA1F2] to-[#0d8ddb] py-16 px-4">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-white/90 text-lg">
                                Download Twitter Videos, Photos, Reels, IGTV & Carousel
                            </p>
                        </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#1DA1F2] transition"
                                    />
                                    <button
                                        onClick={analyze}
                                        disabled={isAnalyzing}
                                        className={`flex items-center justify-center gap-2 bg-gradient-to-r from-[#1DA1F2] to-[#0d8ddb] cursor-pointer text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition-all hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed`}
                                    >
                                        {isAnalyzing ? (
                                            <>
                                                <svg
