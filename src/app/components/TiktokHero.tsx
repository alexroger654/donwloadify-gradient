...
// ========================================== components =====================================================
export default function TiktokHero({activeTab, setActiveTab, tabs, content}: {activeTab: string, setActiveTab: (tab: string) => void, tabs: { id: string; label: string; icon: any; }[], content: { title: string; description: string; placeholder: string; } }) {
    ...
    return (
        <section id="home" className="bg-gradient-to-br from-[#25F4EE] via-[#000000] to-[#FE2C55] py-16 px-4">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-white/90 text-lg">
                                Download Tiktok Videos, Photos, Reels, IGTV & Carousel
                            </p>
                        </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center justify-center gap-2 bg-gradient-to-r from-[#25F4EE] via-[#000000] to-[#FE2C55] cursor-pointer text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition-all hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed`}
                                    >
                                        {isAnalyzing ? (
                                            <>
                                                <svg
                                        ...
                                        <div className="flex items-center space-x-4 p-4 rounded-2xl bg-white/10 border border-white/20">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-white/70 text-sm">
                                                    Duration: {video.duration} • Tiktok
                                                </p>
                                            </div>
